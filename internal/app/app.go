...
func usageError() error {
	return fmt.Errorf("usage: th [--socket PATH] [tui|version|doctor|health|watch [--after SEQUENCE]|export --redacted [--output FILE]|backup FILE [--passphrase-file FILE]|restore FILE [--passphrase-file FILE] [--check] [--wait]|validate PATH|plan PATH [--prune]|apply PATH [--prune] [--wait]|list|get ID|create FILE [--wait]|update FILE [--wait]|enable ID [--wait]|disable ID [--wait]|delete ID|reconcile [ID]]")
}
